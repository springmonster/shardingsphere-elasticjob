...
public final class ShardingListenerManager extends AbstractListenerManager {
    ...
    class ShardingTotalCountChangedJobListener extends AbstractJobListener {
        ...
        protected void dataChanged(final String path, final Type eventType, final String data) {
            log.info("khc ShardingTotalCountChangedJobListener dataChanged path: {} , eventType: {} , data: {}", path, eventType, data);
    ...
    class ListenServersChangedJobListener extends AbstractJobListener {
        ...
        @Override
        protected void dataChanged(final String path, final Type eventType, final String data) {
            log.info("khc ListenServersChangedJobListener dataChanged path: {} , eventType: {} , data: {}", path, eventType, data);
